...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Athallahzaki/pterodactyl-installer"}
...
welcome() {
  ...
  output "https://github.com/Athallahzaki/pterodactyl-installer"
  output ""
